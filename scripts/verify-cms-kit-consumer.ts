  ...
  `${JSON.stringify(
    {
      ...
      dependencies: {
        ...
        "@agency/cms-template-atelier": artifactPath(packages[7][1]),
        "@agency/cms-template-factory": artifactPath(packages[8][1]),
        "@agency/cms-template-rem-viet": artifactPath(packages[9][1]),
        "@agency/cms-visual-editor": artifactPath(packages[10][1]),
