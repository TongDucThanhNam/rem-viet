...
const englishMessages = {
  ...
  cancel: "Cancel",
  close: "Close",
  collectionCaption: "{label} collection",
  collectionSections: "{label} sections",
  collections: "Collections",
  columns: "Columns",
  commandSearch: "Search commands and documents",
  contains: "Contains",
  create: "Create",
  createItem: "Create {label}",
  dashboard: "Dashboard",
  ...
  fixFollowingFields: "Fix the following fields",
  ...
  preview: "Preview",
  previewItemInLocale: "Preview {label} in {locale}",
  previewThisLocale: "Preview this locale",
  publish: "Publish",
  published: "Published",
  recentDocuments: "Recent documents",
  removeFieldRow: "Remove {label} row {index}",
  ...
  selectRelatedDocument: "Select a related document",
  selected: "selected",
  shared: "shared",
  showingLocale: "Showing {locale} locale",
  sorting: "Sorting",
  status: "Status",
  structuredBlocksJsonFallback: "Structured blocks JSON fallback",
  structuredJsonValue: "Structured JSON value",
  structuredRichTextJsonFallback: "Structured rich-text JSON fallback",
  taxonomy: "Taxonomy",
...
export const cmsAdminLocalePacks = Object.freeze({
  ...
  vi: Object.freeze({
    ...
    cancel: "Hủy",
    close: "Đóng",
    collectionCaption: "Bộ sưu tập {label}",
    collectionSections: "Các phần của {label}",
    collections: "Bộ sưu tập",
    columns: "Cột",
    commandSearch: "Tìm lệnh và tài liệu",
    contains: "Chứa",
    create: "Tạo",
    createItem: "Tạo {label}",
    dashboard: "Bảng điều khiển",
    defaultLocale: "mặc định",
    delete: "Xóa",
    deleteView: "Xóa chế độ xem",
    edit: "Chỉnh sửa",
    editItem: "Chỉnh sửa {label}",
    editingLocale: "Ngôn ngữ đang chỉnh sửa",
    equals: "Bằng",
    ...
    filterOperator: "Điều kiện lọc",
    filterValue: "Giá trị lọc",
    fixFollowingFields: "Hãy sửa các trường sau",
    documentTree: "Cây tài liệu",
    globalSearch: "Tìm kiếm toàn cục",
    latitude: "Vĩ độ",
    locale: "Ngôn ngữ",
    localized: "theo ngôn ngữ",
    longitude: "Kinh độ",
    ...
    preview: "Xem trước",
    previewItemInLocale: "Xem trước {label} bằng ngôn ngữ {locale}",
    previewThisLocale: "Xem trước ngôn ngữ này",
    publish: "Xuất bản",
    published: "Đã xuất bản",
    recentDocuments: "Tài liệu gần đây",
    removeFieldRow: "Xóa hàng {index} khỏi {label}",
    removeRow: "Xóa hàng",
    ...
    selectRelatedDocument: "Chọn tài liệu liên quan",
    selected: "đã chọn",
    shared: "dùng chung",
    showingLocale: "Đang hiển thị ngôn ngữ {locale}",
    sorting: "Sắp xếp",
    status: "Trạng thái",
    structuredBlocksJsonFallback: "JSON khối có cấu trúc dự phòng",
    structuredJsonValue: "Giá trị JSON có cấu trúc",
    structuredRichTextJsonFallback: "JSON văn bản đa dạng có cấu trúc dự phòng",
    taxonomy: "Phân loại",
    detachLocalCopy: "Tách thành bản sao cục bộ",
    draft: "Bản nháp",
    loadingReusableContent: "Đang tải nội dung tái sử dụng…",
    totalDocuments: "Tổng cộng {total}",
    usage: "lượt dùng",
    usages: "lượt dùng",
    yes: "Có",
