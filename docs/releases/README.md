...
exact eight-package plan, release-input hashes, and registry non-existence. It
then rebuilds all eight tarballs from the clean source and requires matching
...
it is not part of the stable eight-package publication merely because local
