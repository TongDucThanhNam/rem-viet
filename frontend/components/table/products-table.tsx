...
// import type { ColumnsKey, StatusOptions, Users } from "./table-data";
// import { columns, INITIAL_VISIBLE_COLUMNS, users } from "./table-data";
...
//
//       if (sortDescriptor.column === "externalWorkerID") {
...
//           <h1 className="text-2xl font-[700] leading-[32px]">All Products</h1>
//           <Chip
