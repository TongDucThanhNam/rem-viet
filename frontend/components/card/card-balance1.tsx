                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-4 border-t border-primary-foreground/20">
                        <div className="flex flex-col">
                            <span className="text-xs text-primary-foreground/70">Thu nhập</span>
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs text-primary-foreground/70">Chi phí</span>
                            <div className="flex items-center gap-1">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xs text-primary-foreground/70">Khách VIP</span>
                            <div className="flex items-center gap-1">
                                <span className="text-sm font-semibold text-yellow-400">⭐</span>
                                <span className="text-sm">125</span>
                            </div>
                            <span className="text-xs text-primary-foreground/70">Khách hàng</span>
                        </div>
                    </div>
                </div>
            </CardBody>
