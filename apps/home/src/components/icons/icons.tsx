...
export function SolarMinusCircleLineDuotone(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        <circle cx={12} cy={12} opacity={0.5} r={10} />
  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path d="M15 16.959h7m-13-10H2m0 10h2m18-10h-2" strokeLinecap="round" />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        ...
        <path d="M10 9h4l-4 4h4" strokeLinecap="round" strokeLinejoin="round" />
        <path
...
export const ZaloIcon: FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
...
export const EyeIcon: FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
...
export const EditIcon: FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
...
export const Community: FC<IconSvgProps> = ({
  size = 32,
  width,
  height,
  ...props
