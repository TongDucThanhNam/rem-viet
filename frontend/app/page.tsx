...
import {FUIMeteor} from "@/components/motion/theme-style";
                        ...
                        <div className="flex items-center h-auto justify-center p-4">
                            ...
                            >
                                <div className="z-10 text-center mb-8">
                                    <h1 className="text-4xl md:text-6xl font-bold mb-4">Chào mừng đến với của
                                        hàng <p>Rèm Việt</p></h1>
                                    <p className="text-xl md:text-2xl max-w-2xl mx-auto">Mang đến sự bảo vệ cho gia đình
                                        bạn</p>
                                    ...
                                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                                        <div className="mx-auto max-w-2xl lg:text-center">
                                            ...
                                            <p className="mt-6 text-lg leading-8 ">
                                                ...
                                                an toàn,
                                                tiện nghi cho gia đình bạn. Hãy đến với chúng tôi để trải nghiệm ngay
                                                hôm nay!
                                            </p>
                                        </div>
