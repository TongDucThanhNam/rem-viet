...
CREATE INDEX `products_active_deleted_idx` ON `products` (`is_active`,`is_deleted`);--> statement-breakpoint
...
CREATE INDEX `variants_active_deleted_idx` ON `variants` (`is_active`,`is_deleted`);