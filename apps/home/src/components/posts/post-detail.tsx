  ...
  <figure className="my-8">
    <div className="relative h-96">
      {block.image.type === "file" ? (
        ...
        <Image
          src={`${import.meta.env.PUBLIC_DOMAIN}/cdn-cgi/image/fit=scale-down,width=640,format=auto/${block.image[block.image.type].url}`}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="relative h-96">
          <Image
            src={`${import.meta.env.PUBLIC_DOMAIN}/cdn-cgi/image/fit=scale-down,width=640,format=auto/${myPost.coverImage}`}
